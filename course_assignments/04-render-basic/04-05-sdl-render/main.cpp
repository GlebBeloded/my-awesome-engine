...
int main(int, char**) {
    ...
    const draw_utils::color black = { 0, 0, 0 };
    ...
    struct program : gfx_program {
        ...
        draw_utils::color fragment_shader(const vertex& v_in) override {
            draw_utils::color out;
    ...
    tri_render interpolated_render(width, height, &program01);
    ...
    void*     pixels = interpolated_render.data();
    const int depth  = sizeof(draw_utils::color) * 8;
    const int pitch  = width * sizeof(draw_utils::color);
